...
/** @type {string} */
const CACHE_VERSION = '1785537479|5388589593';
/** @type {string} */
const CACHE_PREFIX = 'Evony Runner: Ap-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Ev2040.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Ev2040.html","Ev2040.js","Ev2040.offline.html","Ev2040.icon.png","Ev2040.apple-touch-icon.png","Ev2040.audio.worklet.js","Ev2040.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Ev2040.wasm","Ev2040.pck"];
